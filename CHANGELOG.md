...
## [2.6.6] - 2025-03-17
### Fixed
- Simplified Lambda bootstrap script using shell script format to ensure maximum compatibility
- Added verification steps in container build to confirm proper entrypoint setup

## [2.6.5] - 2025-03-17
### Fixed
- Updated Docker build process to use direct file copy for bootstrap script to prevent line ending issues
- Enhanced entrypoint configuration to ensure consistent execution across environments

## [2.6.4] - 2025-03-17
### Fixed
- Added symbolic link to bootstrap script to ensure proper AWS Lambda entrypoint compatibility
- Updated container configuration to resolve the exec format error in Lambda environment

## [2.6.3] - 2025-03-14
### Fixed
- Fixed Lambda container bootstrap script to properly handle AWS Lambda entrypoint pattern
- Added test script for local validation of Lambda container functionality
...
- Added comprehensive real scraper tests to validate the scraper's functionality
- Improved test resilience when handling cases with no game data
